(function () {
    ...
    EventLoopAnimation.prototype._reset = function () {
        const newEl = this._initalState.cloneNode(true);
        this._tasksShown = 0;
    ...
    EventLoopAnimation.prototype.popStack = function () {
        return this.action(function (animate) {
    ...
    EventLoopAnimation.prototype.activateMicrotask = function () {
        return this.action(function (animate) {
            const div = this._microtaskRail.children[this._microtasksRemoved];
            return transition(div, {
    ...
    EventLoopAnimation.prototype.shiftMicrotask = function () {
        return this.action(function (animate) {
            ...
            let offset;
            const offsetEl = this._microtaskRail.children[this._microtasksRemoved];
    ...
    EventLoopAnimation.prototype.activateTask = function () {
        return this.action(function (animate) {
            const div = this._taskRail.children[this._tasksRemoved];
            return transition(div, {
                'background-color': '#FFDF1E'
            }, 0.2 * animate, 'ease-in-out');
        }.bind(this));
